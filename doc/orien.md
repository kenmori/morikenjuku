...
- `一般`・・・初めて訪れた方が見れるところ。休学と復帰はこちらに連絡してください
- `レビュー部屋`・・・・・・JS課題などの提出場所
...
0. セットアップ。上記までのこと
1. 日々`discord`を訪れてactive状態でもくもくする。`もくもく部屋` or `ご自身のtimes`(下記)で積み上げ報告
...
塾生が学習に集中できるように&切磋琢磨できるようにもくもく部屋で勉強してもらっています

- 学習中は`Discord内もくもく部屋`でやること
